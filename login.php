    ...
    <body>
      ...
      <div class="login-wrap">
        ...
        <div class="form">
          ...
          <a href="userCreate.php"> <p> Don't have an account? Register </p></a>
        </div>
      </div>
    <?php
      ...
      try {
        ...
        if($un == false && $pass == false){
          return;
        }
        if($un == false){
          print "<script type='text/javascript'>alert('Missing username');</script>";
          return;
        }
        if($pass == false){
          print "<script type='text/javascript'>alert('Missing password');</script>";
          return;
        }
        ...
        if($statement -> rowCount() == 0){
          print "<script type='text/javascript'>alert('No Account with that Username');</script>";
          return;
        }
        ...
        $p = $statement -> fetch();
        if($p["password"] != $pass){
          print "<script type='text/javascript'>alert('Incorrect Password');</script>";
          return;
        }
